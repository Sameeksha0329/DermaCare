...
async function generatePdf(req, res) {
  try {
    ...
    const diseaseInfoResponse = user.uploadedImages[index].diseaseInfoResponse || user.uploadedImages[index].diseaseInfoPrompt;
    const medicinesResponse = user.uploadedImages[index].medicinesResponse || user.uploadedImages[index].medicinesPrompt;
